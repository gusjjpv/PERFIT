...
WSGI_APPLICATION = 'PERFIT.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'perfit_db'),
        'USER': os.environ.get('DB_USER', 'perfit_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'perfit_password'),
